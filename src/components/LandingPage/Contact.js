        ...
        <div className="container m-auto px-4 md:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-center max-w-7xl m-auto gap-12 lg:gap-24">
            ...
            <div className="contactinfo space-y-6 w-full lg:w-1/3 text-center lg:text-left">
              <h3 className="text-2xl sm:text-3xl font-heading text-dark mb-6">Contact Information</h3>
            ...
            <div className="contactform bg-white p-6 md:p-8 rounded-lg w-full lg:w-2/3 shadow-lg">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows={4} className="mt-1 block w-full pl-3 pr-3 py-2 border border-primary rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="Enter your message"></textarea>
                </div>
