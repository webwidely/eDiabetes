...
const HowItWorks = () => {
  const sections = [
    { id: 1, icon: <BookanAppointment />, heading: "Book an Appointment", text: "Schedule online or call us." },
    { id: 2, icon: <ConnectwithYourProvider />, heading: "Connect with Your Provider", text: "Join a virtual appointment through a secure video link." },
    { id: 3, icon: <ReceiveYourPersonalizedPlan />, heading: "Receive Your Personalized Plan", text: "Get a customized care plan based on your health goals." },
    { id: 4, icon: <OngoingSupport />, heading: "Ongoing Support", text: "Continue meeting with your provider and accessing telehealth services for ongoing management." },
  ];
            ...
            {sections.map((section) => (
              ...
              >
                ...
                <div className="text-center text-dark">
                  <h2 className="text-lg sm:text-xl font-bold leading-snug">{section.heading}</h2>
