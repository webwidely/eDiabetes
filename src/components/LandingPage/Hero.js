    ...
    <div className="min-h-screen w-full bg-primary/10 relative flex items-center" id="hero">
      ...
      <div className="container m-auto z-10 flex flex-col-reverse lg:flex-row flex-wrap justify-between items-center px-4 md:px-8">
        ...
        <div className="flex flex-col gap-4 max-w-xl lg:w-1/2 text-center lg:text-left mt-8 lg:mt-0">
          <h2 className="text-xl md:text-2xl font-subheading text-secondary">Managing diabetes has never been easier</h2>
          <h1 className="text-4xl md:text-5xl font-heading text-primary leading-tight -mt-2 lg:-mt-4">
        ...
        <div className="imgdiv max-w-full lg:max-w-4xl lg:w-1/2 order-1 lg:order-2">
          {heroImage ? (
            <GatsbyImage
              image={heroImage}
              alt="Hero Image"
