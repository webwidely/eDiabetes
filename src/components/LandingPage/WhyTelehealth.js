...
const WhyTelehealth = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-white py-[5%]  relative flex items-center" id="why-telehealth">
            <div className="container m-auto px-4 md:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 max-w-5xl m-auto">
                    {sections.map((section, index) => (
                        <div key={index} className="flex flex-col md:flex-row items-center text-center md:text-left gap-4 md:gap-8">
                            {/* Icon Section */}
                            {section.icon && (
                            ...
                            <div>
                                ...
                                <p className="text-base font-body mt-2">
                                    {section.text}
                                </p>
                            </div>
                        </div>
